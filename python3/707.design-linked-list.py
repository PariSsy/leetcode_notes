...
# Solution 1, singly linked list (221 ms, 77%; 14.7 mb, 97%)
class ListNode:
    def __init__(self, x):
        self.val = x
        self.next = None
...
class MyLinkedList:
    ...
    def addAtHead(self, val: int) -> None:
        """
        Add a node of value val before the 1st element of the linked list.
    ...
    def addAtIndex(self, index: int, val: int) -> None:
        ...
        If index > the length, the node will not be inserted.
        """
